...
Version 7.1 adds separate vehicle workspaces, collection status categories, vehicle restoration progress, footer bug reporting, and GitHub-based update checking/updating for the installed edition.
...
UPDATES
The application checks the latest GitHub Release. The installed edition uses Electron's update mechanism.
